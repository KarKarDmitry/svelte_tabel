...
- Открытые пункты ревью: Low п.11-12 (фолбэк-секрет в `compose.yaml`, CSRF/куки), архитектурные п.14-18 (дублирование деревьев, баг native POST на employee-events, крупные файлы, worktime.service.ts, тесты).
